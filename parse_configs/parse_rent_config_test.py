...
class TestRentConfig():
	...
	def test_get_monthly_costs_of_renting(self) -> None:
		...
		with open("/Users/rocky/Downloads/rent_buy_invest/parse_configs/test_config_files/test-rent-config.yaml") as f:
			rent_config = yaml.load(f)
		actual = rent_config.get_monthly_costs_of_renting(25)
		expected = [2420.0]*12 + [round(2420.0 * 1.03, 2)]*12 + [round(2420.0 * 1.03**2, 2)]
